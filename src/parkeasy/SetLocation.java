...
public class SetLocation extends javax.swing.JFrame {
    ...
    public SetLocation() {
        ...
        public SetLocation(int u_id,String u_name) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 153), 2, true), "Set location", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
        ...
        longitudeTF.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N

        latitudeTF.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(longitudeTF, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 231, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSaveMouseClicked
        ...
        try {
             ...
             String sql = "update park_owner set latitude = '" + latitude + "',"
                     + " longitude = '"+ longitude +"',"
                     + "map_location='"+ address +"' where user_id='" + user_id + "' ";
                PreparedStatement statement = connection.prepareStatement(sql);
                statement.executeUpdate();
                JOptionPane.showMessageDialog(null, "Location update is successful.");
                dispose();
    ...
    void setValue(){
            ...
            if (rs.next()) {
                longitudeTF.setText(String.valueOf(rs.getDouble("longitude")));
                latitudeTF.setText(String.valueOf(rs.getDouble("latitude")));
                addressTF.setText(rs.getString("map_location"));
