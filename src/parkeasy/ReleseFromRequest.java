 ...
 * @author Atiq
 */
public class ReleseFromRequest extends javax.swing.JFrame {
    ...
    String u_name,cus_username,cus_vehicle_no,cus_vehicle_type;
    private static Connection connection = null;
    String parkedTableName;
    private String position;

    //Home home;
    public ReleseFromRequest() {
        initComponents();
        ...
        if ((fee + extra) != total) {
            ...
            try {
                ...
                SimpleDateFormat timeformate=new SimpleDateFormat("HH:mm:ss");
                 ...
                 String sql_1 = "insert into book_notification"
                            + "(park_name,date,time,status,approval_status,user_name,notification_type,vehicle_no,"
                         + "vehicle_type,position,sensor_status)"
                            + " values(?,?,?,?,?,?,?,?,?,?,?)";
                    PreparedStatement statement2 = connection.prepareStatement(sql_1);

                    statement2.setString(1, titleLabel.getText());
                    statement2.setString(2, dateformate.format(date));
                    statement2.setString(3, timeformate.format(date));
                    statement2.setInt(4, 1);
                    statement2.setString(5,"booking_confirm");
                    statement2.setString(6,cus_username);
                    statement2.setString(7,"New");
                    statement2.setString(8,cus_vehicle_no);
                    statement2.setString(9,cus_vehicle_type);
                    statement2.setString(10,position);
            ...
            try {
                 String sql_2 = "update response_to_urgent_park set activity = 'finish' where date='" + dateformater.format(date) + "'"
                         + "AND response_for='"+cus_username+"'";
                            PreparedStatement statement = connection.prepareStatement(sql_2);
                            statement.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReleseFromRequest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReleseFromRequest().setVisible(true);
            }
        });
    }
